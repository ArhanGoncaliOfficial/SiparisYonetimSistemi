...
namespace SiparisYonetimSistemi {
    ...
    public partial class SiparisYonetimDBDataSet : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationFK__Purchases__Mater__4BAC3F29;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationFK__Purchases__Mater__4BAC3F29 = this.Relations["FK__Purchases__Mater__4BAC3F29"];
        }
        ...
        private void InitClass() {
            ...
            this.relationFK__Purchases__Mater__4BAC3F29 = new global::System.Data.DataRelation("FK__Purchases__Mater__4BAC3F29", new global::System.Data.DataColumn[] {
                        this.tableMaterials.MaterialIDColumn}, new global::System.Data.DataColumn[] {
                        this.tablePurchases.MaterialIDColumn}, false);
            this.Relations.Add(this.relationFK__Purchases__Mater__4BAC3F29);
        }
        ...
        public partial class PurchasesDataTable : global::System.Data.TypedTableBase<PurchasesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PurchasesRow AddPurchasesRow(MaterialsRow parentMaterialsRowByFK__Purchases__Mater__4BAC3F29, string SupplierName, decimal Quantity, decimal UnitPrice, decimal TotalPrice, System.DateTime PurchaseDate) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        TotalPrice,
                        PurchaseDate};
                if ((parentMaterialsRowByFK__Purchases__Mater__4BAC3F29 != null)) {
                    columnValuesArray[1] = parentMaterialsRowByFK__Purchases__Mater__4BAC3F29[0];
                }
        ...
        public partial class MaterialsRow : global::System.Data.DataRow {
            ...
            public PurchasesRow[] GetPurchasesRows() {
                if ((this.Table.ChildRelations["FK__Purchases__Mater__4BAC3F29"] == null)) {
                    return new PurchasesRow[0];
                }
                else {
                    return ((PurchasesRow[])(base.GetChildRows(this.Table.ChildRelations["FK__Purchases__Mater__4BAC3F29"])));
                }
            }
        }
        ...
        public partial class PurchasesRow : global::System.Data.DataRow {
            ...
            public MaterialsRow MaterialsRow {
                get {
                    return ((MaterialsRow)(this.GetParentRow(this.Table.ParentRelations["FK__Purchases__Mater__4BAC3F29"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["FK__Purchases__Mater__4BAC3F29"]);
                }
            }
...
SELECT OrderID, TableID, UserID, OrderDate, Status FROM Orders WHERE (OrderID = @OrderID)";
    ...
    public partial class PurchasesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Purchases] WHERE (([PurchaseID] = @Original_PurchaseID) AND ((@IsNull_MaterialID = 1 AND [MaterialID] IS NULL) OR ([MaterialID] = @Original_MaterialID)) AND ([SupplierName] = @Original_SupplierName) AND ([Quantity] = @Original_Quantity) AND ([UnitPrice] = @Original_UnitPrice) AND ([TotalPrice] = @Original_TotalPrice) AND ([PurchaseDate] = @Original_PurchaseDate))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Purchases] ([MaterialID], [SupplierName], [Quantity], [UnitPrice], [TotalPrice], [PurchaseDate]) VALUES (@MaterialID, @SupplierName, @Quantity, @UnitPrice, @TotalPrice, @PurchaseDate);
SELECT PurchaseID, MaterialID, SupplierName, Quantity, UnitPrice, TotalPrice, PurchaseDate FROM Purchases WHERE (PurchaseID = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@MaterialID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "MaterialID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Purchases] SET [MaterialID] = @MaterialID, [SupplierName] = @SupplierName, [Quantity] = @Quantity, [UnitPrice] = @UnitPrice, [TotalPrice] = @TotalPrice, [PurchaseDate] = @PurchaseDate WHERE (([PurchaseID] = @Original_PurchaseID) AND ((@IsNull_MaterialID = 1 AND [MaterialID] IS NULL) OR ([MaterialID] = @Original_MaterialID)) AND ([SupplierName] = @Original_SupplierName) AND ([Quantity] = @Original_Quantity) AND ([UnitPrice] = @Original_UnitPrice) AND ([TotalPrice] = @Original_TotalPrice) AND ([PurchaseDate] = @Original_PurchaseDate));
SELECT PurchaseID, MaterialID, SupplierName, Quantity, UnitPrice, TotalPrice, PurchaseDate FROM Purchases WHERE (PurchaseID = @PurchaseID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@MaterialID", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "MaterialID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT PurchaseID, MaterialID, SupplierName, Quantity, UnitPrice, TotalPrice, Pur" +
                "chaseDate FROM dbo.Purchases";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_PurchaseID, global::System.Nullable<int> Original_MaterialID, string Original_SupplierName, decimal Original_Quantity, decimal Original_UnitPrice, decimal Original_TotalPrice, System.DateTime Original_PurchaseDate) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(global::System.Nullable<int> MaterialID, string SupplierName, decimal Quantity, decimal UnitPrice, decimal TotalPrice, System.DateTime PurchaseDate) {
            if ((MaterialID.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> MaterialID, string SupplierName, decimal Quantity, decimal UnitPrice, decimal TotalPrice, System.DateTime PurchaseDate, int Original_PurchaseID, global::System.Nullable<int> Original_MaterialID, string Original_SupplierName, decimal Original_Quantity, decimal Original_UnitPrice, decimal Original_TotalPrice, System.DateTime Original_PurchaseDate, int PurchaseID) {
            if ((MaterialID.HasValue == true)) {
            ...
            this.Adapter.UpdateCommand.Parameters[14].Value = ((int)(PurchaseID));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.UpdateCommand.Connection.State;
            if (((this.Adapter.UpdateCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.UpdateCommand.Connection.Open();
        ...
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> MaterialID, string SupplierName, decimal Quantity, decimal UnitPrice, decimal TotalPrice, System.DateTime PurchaseDate, int Original_PurchaseID, global::System.Nullable<int> Original_MaterialID, string Original_SupplierName, decimal Original_Quantity, decimal Original_UnitPrice, decimal Original_TotalPrice, System.DateTime Original_PurchaseDate) {
            return this.Update(MaterialID, SupplierName, Quantity, UnitPrice, TotalPrice, PurchaseDate, Original_PurchaseID, Original_MaterialID, Original_SupplierName, Original_Quantity, Original_UnitPrice, Original_TotalPrice, Original_PurchaseDate, Original_PurchaseID);
        }
    }
